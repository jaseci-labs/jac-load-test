...
@registry.command(
    ...
    args=[
        ...
        Arg.create("duration", typ=str, default=None, short="",
                   help="Used as the display duration in reports when actual elapsed time is unavailable; does not stop VUs — use --iterations to control run length"),
